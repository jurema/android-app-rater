...
public class Rate implements DialogInterface.OnCancelListener {
	 ...
	 */
	public static void configure(Context context, int daysIntervalFirst,
			int opensIntervalFirst, int daysInterval, int opensInterval,
			String packpageInMarket, String title, String message,
			String rateText, String remindLaterText, String noRateText,
			boolean showLog) {
	...
	public static void showDialog() {
		if (!showInSecion) {
			...
			alertRate = (title != null ? new Dialog(context) : new Dialog(
			...
			Button btnNegative = (Button) alertRate
					.findViewById(R.id.btn_never);
			TextView txtMessage = (TextView) alertRate
					.findViewById(R.id.txt_message);

			LinearLayout.LayoutParams lpInvisible = new LinearLayout.LayoutParams(
					0, 0);
			...
			if (rateText != null) {
				...
				btnPositive.setOnClickListener(new View.OnClickListener() {
					public void onClick(View v) {
						...
						rateAnalyzer
								.resultToHistory(RateAnalyzer.TYPE_SHOW_RATE);
			...
			if (remindLaterText != null) {
				...
				btnNeutral.setOnClickListener(new View.OnClickListener() {
					public void onClick(View v) {
						...
						rateAnalyzer
								.resultToHistory(RateAnalyzer.TYPE_SHOW_LATER);
						alertRate.cancel();
					}
				});
			} else {
			...
			if (noRateText != null) {
				...
				btnNegative.setOnClickListener(new View.OnClickListener() {
					public void onClick(View v) {
						...
						rateAnalyzer
								.resultToHistory(RateAnalyzer.TYPE_SHOW_CANCEL);
						alertRate.cancel();
					}
				});
			} else {
